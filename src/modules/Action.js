...
type ActionType =
  ...
  | 'UPDATE_CRYPTO_EXCHANGE_INFO'
  | 'UPDATE_CRYPTO_REVERSE_EXCHANGE_INFO'
  | 'UPDATE_SHIFT_TRANSACTION_FEE'
  | 'INVALIDATE_SHIFT_TRANSACTION'
  | 'SHIFT_CRYPTO_CURRENCY'
  | 'SHIFT_COMPLETE'
  | 'SHIFT_ERROR'
  | 'OPEN_CRYPTO_EXEC_CONF_MODAL'
  | 'CLOSE_CRYPTO_EXEC_CONF_MODAL'
  | 'START_MAKE_SPEND_CRYPTO'
  | 'DONE_MAKE_SPEND_CRYPTO'
  | 'SET_CRYPTO_EXCHANGE_AMOUNTS'
  ...
  | 'SET_ENABLE_CUSTOM_NODES'
  | 'UPDATE_CUSTOM_NODES_LIST'
  | 'SET_CUSTOM_NODES_MODAL_VISIBILITY'
  | 'UPDATE_CUSTOM_NODES_PROCESSING'
